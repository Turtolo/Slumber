//Code for ConstructControls/ConstructButtonDuo (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class ConstructButtonDuo : global::Gum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("ConstructControls/ConstructButtonDuo");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named ConstructControls/ConstructButtonDuo - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new ConstructButtonDuo(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(ConstructButtonDuo)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("ConstructControls/ConstructButtonDuo", () => 
        {
    ...
    {
        get => TextInstanceLeft.Text;
        set => TextInstanceLeft.Text = value;
    }

    public string TextRight
    {
        get => TextInstanceRight.Text;
        set => TextInstanceRight.Text = value;
    }

    public ConstructButtonDuo(InteractiveGue visual) : base(visual)
    {
    }
    public ConstructButtonDuo()
    {
